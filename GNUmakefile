...
swagger-generator: fmt vendor
	...
	./bin/swagger-generator -source=./api/voidengine/openapi/doc.go -search=./api/voidengine/openapi,./api/common/response,./internal/voidengine/contract -output=./docs/api/voidengine
